...
namespace PrivacyPolicyGeneratorFrontend.SharedKernel.Wrapper
{
    public class Result : IResult
    {
        ...
        public static IResult ValidationFail(List<string> validationErrors, List<string> messages)
        {
            return new Result { Succeeded = false, Messages = messages, ValidationErrors = validationErrors };
        }
        ...
        public static Task<IResult> ValidationFailAsync(List<string> validationErros, string message)
        {
            return Task.FromResult(ValidationFail(new List<string> { message }, validationErros));
        }
    ...
    public class Result<T> : Result, IResult<T>
    {
        ...
        public new static Result<T> ValidationFail(List<string> validationErrors, List<string> messages)
        {
            return new Result<T> { Succeeded = false, Messages = messages, ValidationErrors = validationErrors };
        }
        ...
        public new static Task<Result<T>> ValidationFailAsync(List<string> validationErros, string message)
        {
            return Task.FromResult(ValidationFail(new List<string> { message }, validationErros));
        }
