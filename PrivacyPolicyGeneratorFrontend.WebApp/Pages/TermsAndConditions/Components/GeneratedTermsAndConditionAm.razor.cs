...
namespace PrivacyPolicyGeneratorFrontend.WebApp.Pages.TermsAndConditions.Components
{
    public partial class GeneratedTermsAndConditionAm
    {
        [Parameter]
        public TermsAndConditionsQuestionsModel? _TCQM { get; set; }
        [Parameter]
        ...
        {
            string payment = await localStore.GetItemAsync<string>("TCPayment");
        ...
        {
            var filename = _TCQM.BusinessName + "-Terms & Condition-Am.pdf";
        ...
        public async Task OnPayClicked()
        {
            ...
            _telebirrPaymentCommand.Subject = "Terms and Condition doc payment";
